...
namespace Hyp2Mat {
  ...
  class PCB {
    public:
      ...
      void ReadGerber(std::vector<std::string> gerber_filenames, std::string outline_filename, std::string tools_filename, std::string drill_filename, std::string pickandplace_filename);
