...
public:
  CSXCAD();
  void Write(const std::string& filename, Hyp2Mat::PCB pcb, bool pcb_outline, double kappa, bool lossy_copper); /* save in CSXcad format */
...
private:
  ...
  void export_layer(Hyp2Mat::PCB& pcb, Hyp2Mat::Layer& layer, bool lossy_copper); /* output a copper layer */
  void export_board(Hyp2Mat::PCB& pcb, bool pcb_outline, double kappa); /* output the dielectric */
