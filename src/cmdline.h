...
enum enum_output_format { output_format__NULL = -1, output_format_arg_csxcad = 0, output_format_arg_pdf };
...
struct gengetopt_args_info
{
  ...
  double saturation_arg;	/**< @brief Set PDF color saturation. Range 0.0 to 1.0 (default='0.6').  */
  char * saturation_orig;	/**< @brief Set PDF color saturation. Range 0.0 to 1.0 original value given at command line.  */
  const char *saturation_help; /**< @brief Set PDF color saturation. Range 0.0 to 1.0 help description.  */
